...
// old code with no Order Summary total 
// ========================================================================
// new code with Order Summary total 
...
const App = () => {
  ...
  const handleDecrement = (index) => {
    setCounts((prevCounts) => {
      ...
      if (currentCount === 0) {
        alert(
          "You can't reduce the quantity below 1. Remove the product if needed."
        );
        return prevCounts;
      }
      return {
  ...
  const calculateTotal = () => {
    return cartData.reduce(
      (total, product, index) =>
        total + product.price * (counts[index] || product.quantity),
      0
    );
  };
  return (
        ...
        >
          ...
          <div className="flex justify-between mt-10 mb-5">
            ...
            <span className="font-semibold text-sm">
              {cartData.reduce(
                (total, product, index) =>
                  total + (counts[index] || product.quantity),
                0
              )}
            </span>
          </div>
