...
const Navbar = () => (
  <nav className="navbar sticky top-0 z-50 bg-white shadow-md transition-all duration-300 ease-in-out">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
      ...
      <div className="menu-btn block md:hidden text-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-16">
          ...
          <div>
            ...
            <a
              ...
              className="bg-blue-500 text-white rounded-full p-3 w-32 relative left-28 hover:bg-blue-600 hover:scale-105 transform transition-all duration-300 hover:shadow-lg hover:shadow-blue-500 mt-7 block"
              target="_blank"
              rel="noopener noreferrer"
            >
              Download CV
          ...
          <div className="space-y-4">
            {[
              { head: "Address", subTitle: "Jaipur" },
              {
                ...
                subTitle: (
                  <a
                    href="https://www.linkedin.com/in/pushpendra-soni-1913702a1/"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              },
              {
                ...
                subTitle: (
                  <a
                    href="https://github.com/pushpendra0230"
                    target="_blank"
                    rel="noopener noreferrer"
